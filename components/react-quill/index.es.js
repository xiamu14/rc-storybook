...
function ReactQuill(props) {
    ...
    var quillBoxEl = useRef(null);
    var inputEl = useRef(null);
    var _a = useState("image"), mediaType = _a[0], setMediaType = _a[1];
    var _b = useState(), editor = _b[0], setEditor = _b[1];
    var _c = useState(false), initial = _c[0], setInitial = _c[1];
    // init quill
    useEffect(function () {
        if (!editor) {
            // @ts-ignore
    ...
    return (React.createElement("div", { className: "quill", style: style },
        React.createElement("div", { ref: quillBoxEl, className: "quill_box" }),
        React.createElement("input", { ref: inputEl, type: "file", name: mediaType, accept: mediaType === "image" ? "image/*" : "video/*", style: { display: "none" } })));
}
