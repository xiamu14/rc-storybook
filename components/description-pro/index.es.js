...
function DescriptionsPro(props) {
    ...
    return (React.createElement("div", { className: (center ? "text-align-center descriptions-pro" : "descriptions-pro") + "  " },
        Object.keys(data).length > 0 && !groups ? (React.createElement(Descriptions, __assign({}, other), sortedData.map(function (item, index) {
        ...
        Object.keys(data).length > 0 && groups ? (React.createElement("div", null, sortedData.map(function (group, index) { return (React.createElement(Descriptions, __assign({}, group.props, { key: "" + index }), group.children.map(function (item, index) {
            var content = item.content, otherItem = __rest(item, ["content"]);
            return (React.createElement(Item, __assign({ key: "" + index }, otherItem), item.content));
        }))); }))) : null));
}
